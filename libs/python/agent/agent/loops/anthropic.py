...
MODEL_TOOL_MAPPING = [
    # Claude Opus 4.6, Sonnet 4.6, Opus 4.5 — requires newer computer-use beta
    {
        "pattern": r"claude-(opus|sonnet)-4[._-]6|claude-opus-4[._-]5",
        "tool_version": "computer_20251124",
        "beta_flag": "computer-use-2025-11-24",
    },
    # Claude 4 models (Sonnet 4.5, Haiku 4.5, Opus 4.1, Sonnet 4, Opus 4)
    {
